...
HashMapIterator<Map, IsConst>::HashMapIterator(bucket_array_type *buckets_array, node *node, size_t bucket)
    : _buckets_array(buckets_array), _node(node), _bucket(bucket)
{
}
...
template <typename Map, bool IsConst> HashMapIterator<Map, IsConst> &HashMapIterator<Map, IsConst>::operator++()
{
...
template <typename Map, bool IsConst> HashMapIterator<Map, IsConst> HashMapIterator<Map, IsConst>::operator++(int)
{
